...
export const ABSENT_REPORT_TEMPLATE = `
<!DOCTYPE html>
<html lang="en">
...
<body style="font-family: Arial; padding: 20px; max-width: 600px; margin: auto;">
  ...
  <div style="background-color: #fff3f3; padding: 20px; border-radius: 0 0 8px 8px; box-shadow: 0 0 5px rgba(0,0,0,0.1);">
    <p>Dear Parents,</p>
    <p>We noticed that your child <strong>{studentName}</strong> was <strong>absent</strong> for the subject <strong>{subject}</strong> on <strong>{attendanceDate}</strong> at <strong>{attendanceTime}</strong>.</p>

    <h3>Student Details:</h3>
    <ul>
      <li><strong>Roll Number:</strong> {studentEnrollmentId}</li>
      <li><strong>Branch:</strong> {studentBranch}</li>
      <li><strong>School:</strong> {studentSchool}</li>
      <li><strong>Semester:</strong> {studentSemester}</li>
      <li><strong>Division:</strong> {studentDivision}</li>
    </ul>

    <p>We encourage regular attendance and are here to support your child’s academic journey.</p>
